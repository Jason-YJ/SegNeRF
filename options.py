...
def config_parser():
    ...
    parser.add_argument("--depth_lrate", type=float, default=1e-4,
    ...
    parser.add_argument("--remove", type=bool, default=False,
                        help='whether remove 5th poor prior')
    parser.add_argument("--priorback", type=bool, default=False,
                        help='whether change the depth priors')
    parser.add_argument("--lossrate", type=float, default=0.05,
                        help='seg loss rate in network')
